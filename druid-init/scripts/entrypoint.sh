...
function configure_mysql_metadata_storage() {
  ...
  cp -r /tmp/extensions/mysql-metadata-storage/mysql-metadata-storage-35.0.1.jar /opt/druid/extensions/mysql-metadata-storage/mysql-metadata-storage-35.0.1.jar
}
