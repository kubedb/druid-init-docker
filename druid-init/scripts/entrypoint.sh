...
function configure_mysql_metadata_storage() {
  ...
  cp -r /tmp/extensions/mysql-metadata-storage/mysql-metadata-storage-36.0.0.jar /opt/druid/extensions/mysql-metadata-storage/mysql-metadata-storage-36.0.0.jar
}
